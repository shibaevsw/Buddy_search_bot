...
from dialogs.getters import get_user_data, vk_getter
...
pofile_dialog = Dialog(
    ...
    Window(
        ...
        Column(
            ...
            Button(Const("Инлайн ввод"), id="edit_inline", on_click=ProfileHandlers.edit_inline),
        ),
        Row(
            Button(Format(text=l10n.cancel_btn()), id="cancel", on_click=NavigateHanlers.go_back),
            Button(Format(text=l10n.confirm_btn()), id="confirm", on_click=NavigateHanlers.go_not_fond),
        ),
        getter=get_user_data,
    ...
    Window(
        ...
        TextInput(id="input_first_name", on_success=ProfileHandlers.input_age),
